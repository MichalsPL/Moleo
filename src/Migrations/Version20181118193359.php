 ...
 */
final class Version20181118193359 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE currency (id INT NOT NULL, name VARCHAR(255) DEFAULT NULL, code VARCHAR(3) NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE TABLE exchange_rate_history (id INT NOT NULL, currency_id INT NOT NULL, date DATE NOT NULL, ask_price DOUBLE PRECISION NOT NULL, bid_price DOUBLE PRECISION NOT NULL, PRIMARY KEY(id))');
